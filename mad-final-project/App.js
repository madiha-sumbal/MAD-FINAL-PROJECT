...
import OrderConfirmed from "./screens/OrderConfirmed"; // Import Order Confirmation Screen
    ...
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={{
          ...
          headerShown: false, // Optional: Hide the header on the confirmation screen
        }}
      />
    </Stack.Navigator>
  );
